...
▶️첫 번째(3번), 두 번째(1번) 폰켓몬을 선택
▶️첫 번째(3번), 세 번째(2번) 폰켓몬을 선택
▶️첫 번째(3번), 네 번째(3번) 폰켓몬을 선택
▶️두 번째(1번), 세 번째(2번) 폰켓몬을 선택
▶️두 번째(1번), 네 번째(3번) 폰켓몬을 선택
▶️세 번째(2번), 네 번째(3번) 폰켓몬을 선택
...
function solution(nums) {
  ...
  return choiceNums < nums.length ? choiceNums : nums.length;
}
solution(nums);

//=> 선택할 수 있는 횟수와, 폰켓몬 종류 중복제거한 배열의 길이 중에서 더 적은 것을 리턴!
// Set 객체 : 자료형에 관계 없이 객체에 중복없이 유일한 값을 저장
